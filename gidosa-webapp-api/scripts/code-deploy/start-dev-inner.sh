...
nohup /home/gapture/Downloads/jdk-21/bin/java -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=*:8120 -jar gidosa-webapp-api.jar > /home/gapture/apps-gidosa/logs-backends-all/gidosa-webapp-api.log 2> /home/gapture/apps-gidosa/logs-backends-all/gidosa-webapp-api-error.log &
