...
WEBAPP_BACKEND_FOLDER=gidosa-webapp-backend
WEBAPP_FOLDER="$WEBAPP_BASE_FOLDER/$WEBAPP_BACKEND_FOLDER"

WEBAPP_API_NAME=gidosa-webapp-api
WEBAPP_API_FULL="$WEBAPP_FOLDER/$WEBAPP_API_NAME"

WEBAPP_API_LOGS_FOLDER=logs-backends-all
...
cp -f ${WEBAPP_FOLDER}/gidosa-webapp-backend/build/libs/${WEBAPP_API_NAME}.jar ${WEBAPP_FOLDER}/${WEBAPP_API_NAME}.jar
...
nohup /home/gapture/Downloads/jdk-21/bin/java -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=*:8322 -jar gidosa-webapp-api.jar > /home/gapture/apps-gidosa/logs-backends-all/gidosa-webapp-api.log 2> /home/gapture/apps-gidosa/logs-backends-all/gidosa-webapp-api-error.log &
